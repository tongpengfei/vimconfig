...
"CTest. 格式
syn match cStructUse display "[a-zA-Z0-9_]\{-1,}\.\{1}"ms=s,me=e-1
hi def link cStructUse Type

"CTest::格式
syn match cStructUse2 display "[a-zA-Z0-9_]\{-1,}\::\{1}"ms=s,me=e-2 
hi def link cStructUse2 Type
